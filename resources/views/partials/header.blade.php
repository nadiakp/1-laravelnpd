	                ...
	                <div class="site-header-shown">
						...
						<div class="dropdown user-menu">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
								<a class="dropdown-item" href="{{ route('login') }}"><span class="font-icon glyphicon glyphicon-user"></span>{{ __('Login') }}</a>
								@if (Route::has('register'))
								<a class="dropdown-item" href="{{ route('register') }}"><span class="font-icon glyphicon glyphicon-cog"></span>{{ __('Register') }}</a>
								@endif
							</div>
                        </div>
                                        ...
                                        <div class="tab-pane active" id="tab-incoming" role="tabpanel">
                                            <div class="dropdown-menu-messages-list">
                                                <a href="#" class="mess-item">
                                                    <span class="avatar-preview avatar-preview-32"><img src="{{ asset('build/img/photo-64-2.jpg') }}" alt=""></span>
                                                    <span class="mess-item-name">Tim Collins</span>
                                                    <span class="mess-item-txt">Morgan was bothering about something!</span>
                                                </a>
                                                <a href="#" class="mess-item">
                                                    <span class="avatar-preview avatar-preview-32"><img src="{{ asset('build/img/avatar-2-64.png') }}" alt=""></span>
							...
							<div class="dropdown user-menu">
								...
								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
									...
									<div class="dropdown-divider"></div>
										...
										document.getElementById('logout-form').submit();"><span class="font-icon glyphicon glyphicon-log-out"></span>{{ __('Logout') }}</a>
